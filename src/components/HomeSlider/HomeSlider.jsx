  ...
  return (
    <>
      <Swiper
        ...
        dir="rtl"
      >
        <SwiperSlide className="swiperSlide"><img src="/images/Rectangle.png" alt="" /></SwiperSlide>
        <SwiperSlide className="swiperSlide"><img src="/public/images/ar.png" alt="" /></SwiperSlide>
      </Swiper>
    </>
  );
}
