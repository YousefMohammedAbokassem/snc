  ...
  return (
    <div className="pt-12 container mx-auto">
      ...
      <div className="modern">
        <div className=" h-[400px] rounded-[8px] pb-5">
          ...
          <div className="p-2">
            ...
            <p className="priceInter my-2 text-[#275963]">السعر الدولي: 50$</p>
      ...
      <div className="flex items-center justify-center gap-3 my-10">
          ...
          >
            <path
              d="M1.69629 12H27.5224M27.5224 12L16.5659 1.04346M27.5224 12L16.5659 22.9565"
              stroke="#1D1D1D"
              stroke-width="2"
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="bg-[#275963] rounded-full p-2 cursor-pointer"

          >
            <path
              d="M32.3037 19L6.47762 19M6.47762 19L17.4341 29.9565M6.47762 19L17.4341 8.0435"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
