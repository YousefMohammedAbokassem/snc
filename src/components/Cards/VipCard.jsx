    ...
    <div className="mt-3">
      ...
      <ul className="list-[square] marker:text-[#275963]">
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            يتم إهداء رصيد دولي لمكتبك الالكتروني بقيمة /10.00 قسيمة شرائية/ من
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            VIP حصرا تحصل على مكافأة أولى من إدارة منصةHUN برصيد دولي قيمته /25
            قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            + 10 الجدد) تصنيفاتهم VIP حصرا تحصل على مكافأة ثانية من إدارة
            منصةHUN برصيد دولي قيمته /25 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            + 10 الجدد) تصنيفاتهم VIP حصرا تحصل على مكافأة ثالثة من إدارة
            منصةHUN برصيد دولي قيمته /25 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            + 10 الجدد) تصنيفاتهم VIP حصرا تحصل على مكافأة رابعة وأخيرة من إدارة
            منصةHUN برصيد دولي قيمته /25 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        {/* 10 */}
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            <p>
              ...
              بقيمة/005قسيمة شرائية/كل24ساعة من توقيت الصرف
            </p>
          </div>
        </li>
        {/* 11 */}
