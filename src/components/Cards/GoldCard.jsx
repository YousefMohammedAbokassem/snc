...
export default function GoldCard({ cardType }) {
    ...
    <div className="mt-3">
      ...
      <ul className="list-[square] marker:text-[#275963]">
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            يتم إهداء رصيد دولي لمكتبك الالكتروني بقيمة /5.00 قسيمة شرائية/ من
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            ذهـبـيـة وما فوق تحصل على مكافأة أولى من إدارة منصةHUN برصيد دولي
            قيمته /10 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            + 10 الجدد) تصنيفاتهم ذهـبـيـة وما فوق تحصل على مكافأة ثانية من
            إدارة منصةHUN برصيد دولي قيمته /10 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            + 10 الجدد) تصنيفاتهم ذهـبـية وما فوق تحصل على مكافأة ثالثة من إدارة
            منصةHUN برصيد دولي قيمته /10 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        ...
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            ...
            + 10 الجدد) تصنيفاتهم ذهـبـيـة وما فوق تحصل على مكافأة رابعة وأخيرة
            من إدارة منصةHUN برصيد دولي قيمته /10 قسيمة شرائية/ ولمرة واحدة.
          </div>
        </li>
        {/* 10 */}
        <li className="mt-4">
          ...
          <div className="text-lg mt-2">
            <p>
              يحق لمستخدم هذه التصنيف بصرف رصيده المالي الالكتروني
              بقيمة/100قسيمة شرائية/كل24ساعة من توقيت الصرف
            </p>
          </div>
        </li>
        {/* 11 */}
